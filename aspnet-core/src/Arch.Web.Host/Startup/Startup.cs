...
using Arch.Web.MultiTenancy;
using Abp.HtmlSanitizer;
using Microsoft.AspNetCore.Authentication.Cookies;
using Arch.Web.OpenIddict;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
         ...
         //    .AddNewtonsoftJson(options => options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore);
            ...
            services.AddCors(options =>
            {
                options.AddPolicy(DefaultCorsPolicyName, builder =>
                {
                    ...
                    builder
                        ...
                        .AllowAnyHeader()
                        .AllowAnyMethod()
                        .SetIsOriginAllowed((host) => true)  //enable this if cors issues and disable wildcard line above
                        .AllowCredentials();
                });
            });

            //StripeConfiguration.ApiKey = _appConfiguration["Payment:Stripe:SecretKey"];
            //services.AddScoped<IPaymentGatewayAppService, PaymentGatewayAppService>();
            services.AddScoped<IPaymentGatewayAppService, PaymentGatewayAppService>();
            ...
            var connection = _appConfiguration.GetConnectionString("DatabaseConnection");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (ArchConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            //disable line above and enable this if CORS issues
            //this parts were added

            app.UseDefaultFiles();
            app.UseFileServer();

            app.UseCors(x => x.AllowAnyMethod().AllowAnyHeader().SetIsOriginAllowed((host) => true)
