...
namespace Arch.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetTheme14Settings()
        {
            var themeName = "theme14";
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        ArchDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        ArchDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{ArchDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{ArchDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{ArchDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{ArchDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = ArchDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
