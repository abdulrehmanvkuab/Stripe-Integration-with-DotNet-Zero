...
using Arch.DashboardCustomization.Definitions.Cache;
    ...
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var simplePermissionDependencyForTenantDashboard =
                new ArchSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
            ...
            var generalStats = new WidgetDefinition(
                ...
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new ArchSimplePermissionDependency(
                    requiresAll: true,
            ...
            var simplePermissionDependencyForHostDashboard =
                new ArchSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
