...
/// </summary>
public class ArchSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public ArchSimplePermissionDependency()
    {
    ...
    public ArchSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public ArchSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
