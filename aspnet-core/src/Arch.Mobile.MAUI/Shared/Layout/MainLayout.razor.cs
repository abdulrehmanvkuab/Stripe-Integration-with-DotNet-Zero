...
using Arch.Mobile.MAUI.Services.Tenants;
using Arch.Mobile.MAUI.Helpers;

#if ANDROID
using Arch.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Arch.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Arch.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
