...
using Arch.Mobile.MAUI.Models.User;
using Arch.Core.Threading;
using Arch.Mobile.MAUI.Services.User;
using Microsoft.AspNetCore.Components.Web.Virtualization;

namespace Arch.Mobile.MAUI.Pages.User
{
    public partial class Index : ArchMainLayoutPageComponentBase
    {
