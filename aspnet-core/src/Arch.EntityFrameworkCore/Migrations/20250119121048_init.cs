        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetUserId = table.Column<long>(type: "bigint", nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    OrganizationalUnitId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CcComaSeperated = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BccComaSeperated = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailHandlers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TanentDemographicInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailHandlers_TenantId",
                table: "EmailHandlers",
                column: "TenantId");
