...
namespace Arch.Web
{
    ...
    public class ArchWebCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreCommonModule).GetAssembly()
            //   );

            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreCoreModule).GetAssembly()
            //   );

            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreDataModule).GetAssembly()
            //   );
            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreModelsModule).GetAssembly()
            //   );
            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreServicesModule).GetAssembly()
            //   );
            //Configuration.Modules.AbpAspNetCore()
            //   .CreateControllersForAppServices(
            //       typeof(TicketCoreViewModelsModule).GetAssembly()
            //   );
